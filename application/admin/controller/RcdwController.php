 ...
 *
 */
class RcdwController extends AdminAuthController
{
  //模块基本信息
  private $data = array(
    // 'upload_path' => UPLOAD_PATH,
    'module_url'  => '/admin/rcdw/',
  ...
  public function add()
  {
    ...
    if ($posts->insertGetId($data)) {
      $this->redirect('admin/rcdw/index');
    } else {
  ...
  public function update($id='')
  {
      ...
      if ($posts->update($data)) {
          return $this->success('信息更新成功','/admin/Rcdw/index');
      } else {
          return $posts->getError();
      }
  }
