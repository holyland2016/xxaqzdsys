 ...
 *
 */
class LxController extends AdminAuthController
{
  //模块基本信息
  private $data = array(
  ...
  public function update($id='')
  {
      ...
      if ($posts->update($data)) {
          return $this->success('信息更新成功','/admin/lx/index');
      } else {
          return $posts->getError();
      }
  }
